...
export default function WritingPage() {
  ...
  const [essayPrompt, setEssayPrompt] = useState(
    "Write about your favorite hobby and why you enjoy it. Include at least three reasons and provide examples."
  )
  const [loadingPrompt, setLoadingPrompt] = useState(true)

  useEffect(() => {
    fetch("http://127.0.0.1:8000/api/writing/questions/random")
      .then((res) => res.json())
      .then((data) => {
        setEssayPrompt(data.question)
                ...
                <div className="grid grid-cols-3 gap-4 mb-6 pb-6 border-b-2 border-pink-200">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className="text-xs font-bold text-pink-700 w-8">
                        {fontSize}px
                      </span>
                    </div>
                  </div>
